...
class GoogleSecondPage extends StatefulWidget {
  @override
  _GoogleSecondPageState createState() => _GoogleSecondPageState();
}

class _GoogleSecondPageState extends State<GoogleSecondPage> {
