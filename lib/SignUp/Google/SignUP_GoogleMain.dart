...
import 'package:fitn_earn/SignIN/Google/SignIN_Googlesecond.dart';
import 'package:fitn_earn/SignUp/Google/SignUP_GoogleCancel.dart';
import 'package:fitn_earn/SignUp/Google/SignUP_Googlesecond.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:google_fonts/google_fonts.dart';

class SignUp_Google_mainPage extends StatelessWidget {
  @override
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Divider(height:screenHeight * 0.01,thickness: 1.sp,color: Colors.grey,),
                          ),
                          ...
                          Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  Navigator.of(context).push(MaterialPageRoute(builder: (_)=>SignUP_Google_cancelPage()));
                                },
                              ...
                              ElevatedButton(
                                onPressed: () {
                                  Navigator.of(context).push(MaterialPageRoute(builder: (_)=>SignUP_GoogleSecondPage()));
                                },
                                style: ElevatedButton.styleFrom(
